...
import { LemonButton, LemonCollapse, LemonInput, LemonSwitch } from '@posthog/lemon-ui'
    ...
    const displayContent = (
        <div className="space-y-4">
            ...
            <div className="pt-4 border-t">
                ...
                <p className="text-xs text-secondary mt-1 mb-2">Show when clicking an element matching this selector</p>
                <LemonInput
                    size="small"
                    className="font-mono"
